...
{
    /// <summary>
    /// Classe de Mapeamento com a Entidade de Banco de Dados - T018_CLI_CADAST
    /// </summary>
    /// <autor>
    ...
    public class ClienteIntegral
    {
        ...
        public static OracleDataReader LoadDataDrEntidadeGrupo(string sWhere)
        {
            ...
            OracleDataReader dr = Context.DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTGRUPO, param);
            return dr;
        }
        public static OracleDataReader LoadDataDrEntidadeSubGrupo(string sWhere)
        {
            ...
            OracleDataReader dr = Context.DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTSubGRUPO, param);
            return dr;
        }
        public static OracleDataReader LoadDataDrEntidadeDetalheGrupo(string sWhere)
        {
            ...
            OracleDataReader dr = Context.DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTDetalheGRUPO, param);
            return dr;
        }
        public static OracleDataReader LoadDataDrEntidadeDadosEntidade(string sWhere)
        {
            ...
            OracleDataReader dr = Context.DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTDadosEntidade, param);
            return dr;
        }
        ...
        public static OracleDataReader LoadDataDrSebraeEscritorio(string sWhere)
        {
            ...
            OracleDataReader dr = Context.DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTSebraeEscritorio, param);
            return dr;
        }
        public static OracleDataReader LoadDataDrSebraeRegionalEscr(string sWhere)
        {
            ...
            OracleDataReader dr = Context.DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTRegionalEscr, param);
            return dr;
        }
        public static OracleDataReader LoadDataDrSebraeFederacao(string sWhere)
        {
            ...
            OracleDataReader dr = Context.DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTFederacao, param);
            return dr;
        }
        public static OracleDataReader LoadDataDrSebraeDadosSebrae(string sWhere)
        {
            ...
            OracleDataReader dr = Context.DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTDadosSebrae, param);
            return dr;
        }
        public static OracleDataReader LoadDataDrSebraeDadosSebraeFed(string sWhere)
        {
            ...
            OracleDataReader dr = Context.DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTDadosSebraeFed, param);
            return dr;
        }
        ...
        public static Context.Paginacao LoadDataPaginacaoRelatorio(string Where, int PaginaCorrente, int TamanhoPagina, string ExpressaoOrdenacao)
        {
            Context.Paginacao paginacao = new Context.Paginacao();
            ...
            OracleDataReader dr = Context.DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTPAGRelatorio, parms);
