...
{
    /// <summary>
    /// Classe de Mapeamento com a Entidade de Banco de Dados - T039_pessoa_jur
    /// </summary>
    /// <autor>
    ...
    public class PessoaJuridica
    {
        ...
        public static OracleDataReader LoadDataDrEntidade(int codigo)
        {
            ...
            OracleDataReader dr = Context.DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTIDEntidade, param);
            return dr;
        }

        public static Context.Paginacao LoadDataEntidadePaginacao(string Where)
        {
            ...
            OracleDataReader dr = Context.DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTIDEntidadePAG, parms);
        ...
        public static OracleDataReader LoadDataDrAcaoEntidade(int codigo)
        {
            ...
            OracleDataReader dr = Context.DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTIDAcaoEntidade, param);
            return dr;
        }
        ...
        public static OracleDataReader LoadDataDrLoginEntidade(int codigo)
        {
            ...
            OracleDataReader dr = Context.DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTIDLoginEntidade, param);
            return dr;
        }
        ...
        public static OracleDataReader InsertEntidade(string sCliente, string sTipo, string sConvenio, string dVigenciaini, string dVigenciafim, string sRepresentante, string sRegional, string stpEscritorio, string sFederacao, string sCalcula, string sUsuario)
        {
            ...
            OracleDataReader dr = Context.DataBase.ExecuteReader(CommandType.StoredProcedure, SPInsertEntidade, param);
            return dr;
        }
        ...
        public static OracleDataReader InsertAcaoEntidade(string sCliente, string sTitulo, string dExecucao, string sInsert)
        {
            ...
            OracleDataReader dr = Context.DataBase.ExecuteReader(CommandType.StoredProcedure, SPInsertAcaoEntidade, param);
            return dr;
        }
        #endregion
        ...
        public static OracleDataReader LoadDataDrBuscarCnpj(string Cnpj)
        {
            ...
            OracleDataReader dr = Context.DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTBuscarCnpj, param);
            return dr;
        }
        ...
        public static OracleDataReader LoadDataDrBuscarCPR(string CPR)
        {
            ...
            OracleDataReader dr = Context.DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTBuscarCPR, param);
            return dr;
        }
        ...
        public static OracleDataReader BuscarDadosEmpCont(int codCliente)
        {
            ...
            OracleDataReader dr = Context.DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTBuscarDadosEmpCont, param);
            return dr;
        }
        //
        ...
        public static OracleDataReader LoadDataDrBuscarCNAE20(string CNAE)
        {
            ...
            OracleDataReader dr = Context.DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTBuscarCNAE20, param);
            return dr;
        }
        #endregion
        ...
        public static OracleDataReader LoadDataDrBuscarCPFEmpresa(string CPF)
        {
            ...
            OracleDataReader dr = Context.DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTBuscarCPFEmpresa, param);
            return dr;
        }
        #endregion
