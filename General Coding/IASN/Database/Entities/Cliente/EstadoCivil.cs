...
{
    /// <summary>
    /// Classe de Mapeamento com a Entidade de Banco de Dados - T598_estado_civil
    /// </summary>
    /// <autor>
    ...
    public class EstadoCivil
    {
        ...
        {
            get { return codEstCivil; }
            set { codEstCivil = value; }
        }
       public string DscEstCivil
        {
            get { return dscEstCivil; }
            set { dscEstCivil = value; }
        }        
        ...
        public EstadoCivil()
            : this(-1)
        { }
        public EstadoCivil(int codEstCivil)
        {
        ...
        private const string SPINSERT = "EstadoCivil.EstadoCivilInc";
        private const string SPUPDATE = "EstadoCivil.EstadoCivilAlt";
        private const string SPDELETE = "EstadoCivil.EstadoCivilDel";
        private const string SPSELECTID = "EstadoCivil.EstadoCivilSelId";
        private const string SPSELECTPAG = "EstadoCivil.EstadoCivilSelPag";
        #endregion

        #region Parametros Oracle
        private const string PARMCODIGO = "codEstCivil";
        #endregion
        ...
        public static OracleParameter[] GetParameters()
        {
            ...
            if (parms == null)
            {
                parms = new OracleParameter[]{ 
                    ...
                    /*1*/ new OracleParameter( "dscEstCivil", OracleType.VarChar),
        ...
        {
            parms[0].Value = this.codEstCivil;
            parms[1].Value = this.dscEstCivil;
            parms[2].Value = this.logUsuario;
            if (this.codEstCivil < 0)
            {
            ...
            using (OracleConnection conn = new OracleConnection(Context.DataBase.CONN_STRING))
            {
                ...
                using (OracleTransaction trans = conn.BeginTransaction())
                {
                    try
                    {
                        ...
                        codEstCivil = Convert.ToInt32(cmd.Parameters[PARMCODIGO].Value);
        ...
        public static OracleDataReader LoadDataDr(int codigo)
        {
            OracleParameter[] param = new OracleParameter[] { 
                    ...
                    new OracleParameter("curEstadoCivil", OracleType.Cursor)
                };
        ...
        public static EstadoCivil GetDataRow(int codigo)
        {
            OracleDataReader dr = LoadDataDr(codigo);
            EstadoCivil clienteI = new EstadoCivil();
            try
            {
                if (dr.Read())
                {
                    clienteI.codEstCivil = Convert.ToInt32(dr["A598_cd_est_civ"]);
                    clienteI.dscEstCivil = Convert.ToString(dr["A598_dsc_est_civ"]);
        ...
        /// <param name="trans">OracleTransaction</param>
        /// <returns>EstadoCivil</returns>
        public static EstadoCivil GetDataRow(int codigo, OracleTransaction trans)
        {
