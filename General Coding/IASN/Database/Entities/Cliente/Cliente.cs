...
{
    /// <summary>
    /// Classe de Mapeamento com a Entidade de Banco de Dados - T012_cli_atend
    /// </summary>
    /// <autor>
    ...
    public class Cliente
    {
        ...
        public static OracleDataReader LoadDataDrRegEsc(int codigo)
        {
            ...
            OracleDataReader dr = Context.DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTRegEsc, param);
            return dr;
        }
        ...
        public static OracleDataReader LoadDataDrParametro(string busca)
        {
            ...
            OracleDataReader dr = Context.DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTParametro, param);
            return dr;
        }
        ...
        public static OracleDataReader LoadDataDrSelectComun(string sCampos,string sTabela,string sWhere)
        {
            ...
            OracleDataReader dr = Context.DataBase.ExecuteReader(CommandType.StoredProcedure, SPSelectComun, param);
            return dr;
        }
        ...
        public static OracleDataReader LoadDataDrInsertComun(string sCampos, string sTabela, string sValores)
        {
            ...
            OracleDataReader dr = Context.DataBase.ExecuteReader(CommandType.StoredProcedure, SPInsertComun, param);
            return dr;
        }
