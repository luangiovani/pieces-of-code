...
{
    /// <summary>
    /// Classe de Mapeamento com a Entidade de Banco de Dados - T031_INST_EV
    /// </summary>
    /// <autor>
    ...
    public class InstrutorEvento 
    {
        ...
        public static OracleDataReader LoadDataTConsultarInstrutor(string CdEvento, string DtInicio, string DtFim, string Entidade)
        {
            ...
            OracleDataReader dr = Context.DataBase.ExecuteReader(CommandType.StoredProcedure, SPTConsultarInstrutor, param);
            return dr;
        }
        ...
        public static string GetNomeInstrutor(int codEvento)
        {
            ...
            Context.Paginacao ins = InstrutorEvento.LoadDataPaginacao(" and a022_cd_ev = " + codEvento, 1, 5, "nvl(a031_assina_certif,0) desc");
        ...
        { 
            ...
            Context.Paginacao ie = InstrutorEvento.LoadDataPaginacao(where, 1, 100, "2"); 
        ...
        public static OracleDataReader LoadDataDrExiste(int codInstrutor, int codEvento, DateTime dataInicial, DateTime dataFinal)
        {
            ...
            OracleDataReader dr = Context.DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTEXISTE, parms);
        ...
        public static OracleDataReader LoadDataDrContrato(int codEvento)
        {
            ...
            OracleDataReader dr = Context.DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTCONTRATO, param);
            return dr;
        }
