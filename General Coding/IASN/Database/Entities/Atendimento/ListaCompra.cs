...
{
    /// <summary>
    /// Classe de Mapeamento com a Entidade de Banco de Dados - T289_LISTA_COMPRA
    /// </summary>
    /// <autor>
    ...
    public class ListaCompra
    {
        ...
        public static OracleDataReader LoadDataBuscaEventos(int codEvento, int codCliente)
        {
            ...
            OracleDataReader dr = Context.DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTBUSCA, parms);
            return dr;
        }
        #endregion
        ...
        public static OracleDataReader LoadDataBuscaPagos(int NumSeqPagto)
        {
            ...
            OracleDataReader dr = Context.DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTBUSCAPAGOS, parms);
            return dr;
        }
        #endregion
        #endregion
