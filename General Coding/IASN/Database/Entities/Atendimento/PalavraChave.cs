...
{
    /// <summary>
    /// Classe de Mapeamento com a Entidade de Banco de Dados - T081_pal_chave
    /// </summary>
    /// <autor>
    ...
    public class PalavraChave
    {
        ...
        private string dscPalavra;
        private string logusuario;
        #endregion

        #region Propriedades
        public int CodPalavraChave
        {
            get { return codPalavra; }
            set { codPalavra = value; }
        }
        public string DscPalavraChave
        {
            get { return dscPalavra; }
            set { dscPalavra = value; }
        }
        ...
        public PalavraChave()
            : this(-1)
        { }
        public PalavraChave(int codPalavra)
        {
        ...
        private const string SPINSERT = "PalavraChave.PalavraChaveInc";
        private const string SPUPDATE = "PalavraChave.PalavraChaveAlt";
        private const string SPDELETE = "PalavraChave.PalavraChaveDel";
        private const string SPSELECTID = "PalavraChave.PalavraChaveSelId";
        private const string SPSELECTPAG = "PalavraChave.PalavraChaveSelPag";
        #endregion

        #region Parametros Oracle
        private const string PARMCODIGO = "codPalavra";
        #endregion
        ...
        public static OracleParameter[] GetParameters()
        {
            ...
            if (parms == null)
            {
                ...
                /*1*/ new OracleParameter( "dscPalavra", OracleType.VarChar),
        ...
        public void SetParameters(OracleParameter[] parms)
        {
            ...
            parms[1].Value = this.dscPalavra.ToUpper();
            ...
            using (OracleConnection conn = new OracleConnection(Context.DataBase.CONN_STRING))
            {
                ...
                using (OracleTransaction trans = conn.BeginTransaction())
                {
                    try
                    {
                        ...
                        codPalavra = Convert.ToInt32(cmd.Parameters[PARMCODIGO].Value);
        ...
        public static OracleDataReader LoadDataDr(int codigo)
        {
            OracleParameter[] param = new OracleParameter[] { 
                ...
                new OracleParameter("curPalavraChave", OracleType.Cursor)
            };
        ...
        /// </summary>
        /// <param name="codigo">Código do Registro</param>
        /// <returns>PalavraChave</returns>
        public static PalavraChave GetDataRow(int codigo)
        {
            OracleDataReader dr = LoadDataDr(codigo);
            PalavraChave palavraC = new PalavraChave();
            try
            {
                if (dr.Read())
                {
                    palavraC.codPalavra = Convert.ToInt32(dr["A081_cd_palavra"]);
                    palavraC.dscPalavra = Convert.ToString(dr["A081_palavra"]);
                    palavraC.logusuario = Convert.ToString(dr["usu_inc_alt"]);
                }
            }
            catch (Exception ex)
            {
        ...
        /// <param name="trans">OracleTransaction</param>
        /// <returns>PalavraChave</returns>
        public static PalavraChave GetDataRow(int codigo, OracleTransaction trans)
        {
