...
{
    /// <summary>
    /// Classe de Mapeamento com a Entidade de Banco de Dados - T052_Usuario
    /// </summary>
    /// <autor>
    ...
    public class Usuario
    {
            ...
            using (OracleConnection conn = new OracleConnection(Context.DataBase.CONN_STRING))
            {
                ...
                using (OracleTransaction trans = conn.BeginTransaction())
                {
                    try
                    {
                        ...
                        OracleCommand cmd = Context.DataBase.ExecuteNonQueryCmd(trans, CommandType.StoredProcedure, SPINSERTLOGINAD, parmsVinculo);
        ...
        public static Int32 EncontraUsuario(string login)
        {
            ...
            Int32 dr = Context.DataBase.ExecuteNonQuery(CommandType.StoredProcedure, SPSELECTLOGIN, param);
            //Obtendo a chave de identificação do registro inserido.
        ...
        public static Int32 EncontraUsuario(string login, OracleTransaction trans)
        {
            ...
            Int32 dr = Context.DataBase.ExecuteNonQuery(trans, CommandType.StoredProcedure, SPSELECTLOGIN, param);
            //Obtendo a chave de identificação do registro inserido.
            Int32 codUsuario = Convert.ToInt32(param[1].Value);
            return codUsuario;
        }
