...
{
    /// <summary>
    /// Classe de Mapeamento com a Entidade de Banco de Dados - T016_QDO_AVISO
    /// </summary>
    /// <autor>
    ...
    public class Aviso
    {
        ...
        public static OracleDataReader LoadDataDrDetalheInstrutor(int codigo)
        {
            ...
            OracleDataReader dr = Context.DataBase.ExecuteReader(CommandType.StoredProcedure, SPDetalheInstrutor, param);
            return dr;
        }
        ...
        public static OracleDataReader LoadDataDrDetalheProduto(int codigo)
        {
            ...
            OracleDataReader dr = Context.DataBase.ExecuteReader(CommandType.StoredProcedure, SPDetalheProduto, param);
            return dr;
        }
