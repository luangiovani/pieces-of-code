...
namespace Framework.Domain.Model.CBL
{
    ...
    /// <sumary>
    /// Mapeamento da Entidade TypeOfContact (Tipo de Contato), para gravação na tabela TypeOfContact no Banco de Dados
    /// </sumary>
    /// <last_modified_task_url>https://esfera.teamworkpm.net/tasks/7054873</last_modified_task_url>
    /// <last_modified_date>3108/2016</last_modified_date>
    /// <last_modified_programmer>Luan Fernandes</last_modified_programmer>
    /// <last_modified_sumary>Ajustes após remodelagem de dados</last_modified_sumary>
    public class TypeOfContactViewModel
    {
        /// <summary>
        /// Type of Contact ID
        ...
        /// </summary>
        [Key]
        [Display(Name="Type of Contact ID")]
        public int typeContact_id { get; set; }

        /// <summary>
        /// Name
        /// Nome do Tipo de Contato
        /// </summary>
