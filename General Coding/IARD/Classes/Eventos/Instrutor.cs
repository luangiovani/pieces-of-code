...
namespace Classes
{
    public class Instrutor /// T125_INSTRUTOR
    {
        #region Atributos
        ...
        public static OracleDataReader LoadDataRegiaoDr(int codigo)
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTREGIAOID, param);
            return dr;
        }
        ...
        public static OracleDataReader LoadDataAreaDr(int codigo)
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTAREAID, param);
            return dr;
        }
        ...
        public static OracleDataReader LoadDataCredenciadoDr(int codigo)
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTCREDENCIADOID, param);
            return dr;
        }
        ...
        public static Paginacao LoadDataPaginacaoQuestionario(string Where, int PaginaCorrente, int TamanhoPagina, string ExpressaoOrdenacao)
        {
            Paginacao paginacao = new Paginacao();
            ...
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTPAGQuestionario, parms);
        ...
        public static OracleDataReader InstrutorHabilitadoSelId(int codInstrutor, int codEscritorio, int codTituloEv, int codEscritorioReginal)
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECESTInstrutorHabilitado, param);
            return dr;
        }
        ...
        public static OracleDataReader InstrutorPagamentoSelId(int codEvento)
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECESTInstrutorPagamento, param);
            return dr;
        }
