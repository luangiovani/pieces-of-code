...
namespace Classes
{
    public class Eventos /// T022_eventos
    {
        #region Atributos
        ...
        public void UpdateConfirmacao(OracleTransaction trans)
        {
            ...
            try
            {
                DataBase.ExecuteNonQuery(trans, CommandType.StoredProcedure, SPUPDATEConfirmacao, parms);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public void UpdateFechamento(OracleTransaction trans)
        {
            ...
            try
            {
                DataBase.ExecuteNonQuery(trans, CommandType.StoredProcedure, SPUPDATEFechamento, parms);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public static void DeleteQuestionario(int codevento, int codaval, int codquest)
        {
            ...
            using (OracleConnection conn = new OracleConnection(DataBase.CONN_STRING))
            {
                ...
                using (OracleTransaction trans = conn.BeginTransaction())
                {
                    try
                    {
                        DataBase.ExecuteNonQuery(trans, CommandType.StoredProcedure, SPDELETEQUEST, parms);
                        trans.Commit();
                    }
                    catch (OracleException ex)
                    {
        ...
        public static void InsertQuestionario(int codAval, int codQuest, int codInst, int codEvento)
        {
            ...
            using (OracleConnection conn = new OracleConnection(DataBase.CONN_STRING))
            {
                ...
                using (OracleTransaction trans = conn.BeginTransaction())
                {
                    try
                    {
                        DataBase.ExecuteNonQuery(trans, CommandType.StoredProcedure, SPINSERTQUESTNull, parms);
                        trans.Commit();
                    }
                    catch (OracleException ex)
                    {
        ...
        public static void InsertRespostaQuestionario(int codEvento, int codAval, int codQuest, int codPerg, int codResp, string dscResp)
        {
            ...
            using (OracleConnection conn = new OracleConnection(DataBase.CONN_STRING))
            {
                ...
                using (OracleTransaction trans = conn.BeginTransaction())
                {
                    try
                    {
                        DataBase.ExecuteNonQuery(trans, CommandType.StoredProcedure, SPINSERTQUESTRESP, parms);
                        trans.Commit();
                    }
                    catch (OracleException ex)
                    {
        ...
        public static void DeleteInstrutorEvento(int codigo)
        {
            ...
            using (OracleConnection conn = new OracleConnection(DataBase.CONN_STRING))
            {
                ...
                using (OracleTransaction trans = conn.BeginTransaction())
                {
                    try
                    {
                        DataBase.ExecuteNonQuery(trans, CommandType.StoredProcedure, SPDELETEINSEV, parms);
                        trans.Commit();
                    }
                    catch (OracleException ex)
                    {
        ...
        public static OracleDataReader LoadDataEventoInstrutorDr(int codigo)
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTINSTRUTOR, param);
            return dr;
        }
        ...
        public static OracleDataReader LoadDataInsHoraCompDr(int data, int instrutor)
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELEVINSHORACOMP, param);
            return dr;
        }
        ...
        public static OracleDataReader LoadDataEventoHorasInstrutorDr(int codigo)
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTHORASINSTRUTOR, param);
            return dr;
        }
        ...
        public static OracleDataReader LoadDataIncluiReplicacao(int titulo, int evento, int cliente)
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, SPIncluiReplicacaoId, param);
            return dr;
        }
        ...
        public static OracleDataReader LoadDataPesquisaCarta(string sWhere)
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, SPPesquisaCarta, param);
            return dr;
        }
        ...
        public static OracleDataReader LoadDataConsultarRecibo(int lngCdAgencia, string strDtInicio, string strDtFim, int lngIdFatura, int lngCdRecibo, int lngCdTitulo, int lngCdEvento)
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, SPConsultarRecibo, param);
            return dr;
        }
        ...
        public static OracleDataReader LoadDataGerar_Relatorio(string Entidade, string dt_inicio, string dt_fim, string tp_relatorio, string agencia, string entidadeX, string grupo, string produto, string Tipo, int Federacao )
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, SPGerar_Relatorio, param);
            return dr;
        }
        ...
        public static OracleDataReader LoadDataConsultarDetalhesOS(string Evento, string Ordem, string Parcela)
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, SPConsultarDetalhesOS, param);
            return dr;
        }
        ...
        public static OracleDataReader LoadDataEventoMesRef()
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTMESREF, param);
            return dr;
        }
        ...
        public static OracleDataReader LoadDataDrPagamento(int codigo)
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTPagamentoID, param);
            return dr;
        }
        ...
        public static OracleDataReader LoadDataDrQuestionario(int codigoQuestionario)
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTQuestionarioID, param);
            return dr;
        }
        ...
        public static OracleDataReader LoadDataDrCliQuest( int codigoQuestionario, int codigoCliente, int codigoContato, int codigoInstrutor, int codigoEvento)
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTQuestionarioCliSelId, param);
            return dr;
        }
        ...
        public static OracleDataReader LoadDataDrResQuest(int codigoQuestionario, int codigoCliente, int codigoContato, int codigoInstrutor, int codigoEvento)
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTQuestionarioResSelId, param);
            return dr;
        }
        ...
        public static Paginacao LoadDataPaginacaoJustificado(string Where, int PaginaCorrente, int TamanhoPagina, string ExpressaoOrdenacao)
        {
            Paginacao paginacao = new Paginacao();
            ...
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTPAGJus, parms);
        ...
        public static Paginacao LoadDataAtingido(string Where, int PaginaCorrente, int TamanhoPagina, string ExpressaoOrdenacao)
        {
            Paginacao paginacao = new Paginacao();
            ...
            parms[4].Direction = ParameterDirection.Output;
            parms[5].Direction = ParameterDirection.Output;
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTAtingido, parms);
            paginacao.DataReader = dr;
            //  traz o total de registros de retorno direto dos parametros do ExecuteReader---
            paginacao.TotalRegistros = Convert.ToInt32(parms[5].Value);
            return paginacao;
        ...
        public static Paginacao LoadDataDepartamento(string Where, int PaginaCorrente, int TamanhoPagina, string ExpressaoOrdenacao)
        {
            Paginacao paginacao = new Paginacao();
            ...
            parms[4].Direction = ParameterDirection.Output;
            parms[5].Direction = ParameterDirection.Output;
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTDepartamento, parms);
            paginacao.DataReader = dr;
            //  traz o total de registros de retorno direto dos parametros do ExecuteReader---
            paginacao.TotalRegistros = Convert.ToInt32(parms[5].Value);
            return paginacao;
        ...
        public static OracleDataReader InsertDepartamento(string sInsertUpdate, string sa236_cd_depto, string sCODSOL, string sCODOBJ)
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, SPInsertDepartamento, param);
            return dr;
        }
            ...
            , string sCODSOL , string sCODOBJ, string sA522_CD_CATEGORIA, string sA522_TIPO, string sA004_cd_escr, string sA522_CdCanalInfor)
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, SPInsertAtingido, param);
            return dr;
        }
        ...
        public static OracleDataReader FecharEvento(string strusuario, string senha, string lngcdevento, string strparcelas)
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, SPFecharEvento, param);
            return dr;
        }
        ...
        public static OracleDataReader LoadDataDdlEscr()
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTESCR, param);
            return dr;
        }
        ...
        public static OracleDataReader LoadDataDdlEscr(OracleTransaction trans)
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(trans, CommandType.StoredProcedure, SPSELECTESCR, param);
            return dr;
        }
        ...
        public static OracleDataReader LoadDataDdlProdSebrae()
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTPRODESB, param);
            return dr;
        }
        ...
        public static OracleDataReader LoadDataDdlProdSebrae(OracleTransaction trans)
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(trans, CommandType.StoredProcedure, SPSELECTPRODESB, param);
            return dr;
        }
        ...
        public static OracleDataReader LoadDataEstpais(string nomCidade,string nomEstado,string nomPais)
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECESTPAIS, param);
            return dr;
        }
        ...
        public static OracleDataReader LoadDataEstpais(OracleTransaction trans)
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(trans, CommandType.StoredProcedure, SPSELECESTPAIS, param);
            return dr;
        }
        ...
        public static OracleDataReader LoadDataDdlInstAbordCateg(string where)
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTINSTABORDCATEG, param);
            return dr;
        }
        ...
        public static OracleDataReader LoadDataDdlInstAbordCateg(string where, OracleTransaction trans)
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(trans, CommandType.StoredProcedure, SPSELECTINSTABORDCATEG, param);
            return dr;
        }
        ...
        public static OracleDataReader LoadDataVagaCargaEM(int codEventoPrin, int codEvento)
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTVAGACARGA, param);
            return dr;
        }
        ...
        public static OracleDataReader LoadDataVagaCargaEM(int codEventoPri, int codEvento, OracleTransaction trans)
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(trans, CommandType.StoredProcedure, SPSELECTVAGACARGA, param);
            return dr;
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static Paginacao LoadDataEventosInscritos()
        {
            ...
            Paginacao drEv = Eventos.LoadDataPaginacao(where, 1, 1000, "A022_nm_ev");
        ...
        public static Paginacao LoadDataEventosAbertosFechado(int indAberto, string whereFiltro)
        {
        ...
        public static OracleDataReader LoadDataEventosFechadosAtual()
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTEVFECHADOATUAL, param);
        ...
        public static OracleDataReader LoadDataDdlTipo()
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTTIPO, param);
            return dr;
        }
        ...
        public static OracleDataReader LoadDataDdlTipo(OracleTransaction trans)
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(trans, CommandType.StoredProcedure, SPSELECTTIPO, param);
            return dr;
        }
        ...
        public static OracleDataReader LoadDataDdlEscritorio(OracleTransaction trans)
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(trans, CommandType.StoredProcedure, SPSELECTESCRITORIO, param);
            return dr;
        }
        ...
        public static OracleDataReader LoadDataDdlTitulo()
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTTITULO, param);
            return dr;
        }
        ...
        public static OracleDataReader LoadDataDdlTitulo(OracleTransaction trans)
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(trans, CommandType.StoredProcedure, SPSELECTTITULO, param);
            return dr;
        }
