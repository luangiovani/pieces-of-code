...
namespace Classes
{
    public class ParticiGratuito // T1134_ParticiGratuito  
    {
        #region Atributos
        ...
        #region Construtores
        public ParticiGratuito()
            : this(-1)
        { }
        public ParticiGratuito(int codCliente)
        {
        ...
        private const string SPINSERT = "ParticiGratuito.ParticiGratuitoInc";
        private const string SPUPDATE = "ParticiGratuito.ParticiGratuitoAlt";
        private const string SPDELETE = "ParticiGratuito.ParticiGratuitoDel";
        private const string SPSELECTID = "ParticiGratuito.ParticiGratuitoSelId";
        private const string SPSELECTPAG = "ParticiGratuito.ParticiGratuitoSelPag";
        #endregion

        #region Parametros Oracle
        private const string PARMCODCLIENTE = "codCliente";
        private const string PARMCODEVENTO = "codEvento";
        private const string PARMCURSOR = "curParticiGratuito";
        #endregion
        ...
        /// </summary>
        /// <param name="codCliente">Código do Registro</param>
        /// <returns>ParticiGratuito</returns>
        public static ParticiGratuito GetDataRow(int codCliente, int codEvento)
        {
            OracleDataReader dr = LoadDataDr(codCliente, codEvento);
            ParticiGratuito pe = new ParticiGratuito();
            try
            {
                if (dr.Read())
                {
        ...
        /// <param name="trans">OracleTransaction</param>
        /// <returns>ParticiGratuito</returns>
        public static ParticiGratuito GetDataRow(int codCliente, int codEvento, OracleTransaction trans)
        {
