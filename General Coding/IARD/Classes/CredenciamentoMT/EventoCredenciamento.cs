...
namespace Classes
{
    public class EventoCredenciamento  // T922_evento_credenc 
    {
        #region Atributos
        ...
        public static OracleDataReader LoadDataPerguntaEvento(int codEvento)
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTPERGUNTAEVENTO, param);
