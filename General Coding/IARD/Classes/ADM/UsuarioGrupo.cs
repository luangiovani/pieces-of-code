...
namespace Classes
{
    public class UsuarioGrupo // T616_UsuarioGrupo 
    {
        #region Atributos
        ...
        public static OracleDataReader LoadDataDrUsuario(int codUsuario)
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTUSUARIO, param);
            return dr;
        }
        /// <summary>
        /// LoadDataDr
        ...
        public static OracleDataReader LoadDataDrUsuario(int codUsuario, OracleTransaction trans)
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(trans, CommandType.StoredProcedure, SPSELECTUSUARIO, param);
            return dr;
        }
        #endregion
