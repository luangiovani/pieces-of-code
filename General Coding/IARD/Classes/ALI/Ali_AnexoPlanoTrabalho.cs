...
namespace Classes
{
    public class Ali_AnexoPlanoTrabalho // TB0658_ANEXOS_PLANO_TRABALHO
    {
        #region Atributos
        ...
        #region Construtores
        public Ali_AnexoPlanoTrabalho()
            : this(-1)
        { }
        public Ali_AnexoPlanoTrabalho(int codAnexo)
        {
        ...
        private const string SPINSERT = "ALI_AnexoPlano.AnexosPlanoInc";
        private const string SPUPDATE = "ALI_AnexoPlano.AnexosPlanoAlt";
        private const string SPDELETE = "ALI_AnexoPlano.AnexosPlanoDel";
        private const string SPSELECTID = "ALI_AnexoPlano.AnexosPlanoSelId";
        private const string SPSELECTPAG = "ALI_AnexoPlano.AnexosPlanoSelPag";
        private const string SPSELECTPLANO = "ALI_AnexoPlano.AnexosPlanoSelProjeto";
        #endregion
        ...
        public static OracleParameter[] GetParameters()
        {
            ...
            if (parms == null)
            {
                parms = new OracleParameter[]{ 
                    ...
                    /*3*/ new OracleParameter( "codProjeto", OracleType.Int32),
        ...
        public void SetParameters(OracleParameter[] parms)
        {
            ...
            parms[3].Value = this.projeto.CodProjeto;
        ...
        public static Ali_AnexoPlanoTrabalho GetDataRow(int codigo)
        {
            OracleDataReader dr = LoadDataDr(codigo);
            Ali_AnexoPlanoTrabalho ali = new Ali_AnexoPlanoTrabalho();
            try
            {
                if (dr.Read())
                {
                    ali.codAnexo = Convert.ToInt32(dr["A0658_COD_ANEXO"]);
                    ali.projeto = new Ali_Projeto(Convert.ToInt32(dr["A0606_COD_PROJETO"]));
                    ali.nome = dr["A0658_NM_ARQUIVO"].ToString();
                    ali.url = dr["A0658_URL"].ToString();
                }
            }
            catch (Exception ex)
            {
                if (!dr.IsClosed)
                    dr.Close();
                ali = new Ali_AnexoPlanoTrabalho();
                throw (ex);
            }
            finally
            {
        ...
        /// <param name="trans">OracleTransaction</param>
        /// <returns>Usuario</returns>
        public static Ali_AnexoPlanoTrabalho GetDataRow(int codigo, OracleTransaction trans)
        {
        ...
        #region LoadDataDrProjeto
        public static OracleDataReader LoadDataDrProjeto(int codProjeto)
        {
            OracleParameter[] param = new OracleParameter[] { 
