...
namespace Classes
{
    public class SubTema  // T050_SUBTEMA  
    {
        #region Atributos
        ...
        public static OracleDataReader LoadDataDrAssunto(string assunto)
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTASSUNTO, param);
            return dr;
        }
        ...
        public static OracleDataReader LoadDataDrAssunto(string assunto, OracleTransaction trans)
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(trans, CommandType.StoredProcedure, SPSELECTASSUNTO, param);
            return dr;
        }
