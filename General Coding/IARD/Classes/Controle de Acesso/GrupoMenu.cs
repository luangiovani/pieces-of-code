...
//-- Inserção do atributo indManutencao 

namespace Classes
{
    public class GrupoMenu // T616_GrupoMenu 
    {
        #region Atributos
        ...
        public static OracleDataReader LoadDataDrUsuarioModulo(int codUsuario, int codModulo)
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTUSUARIOMODULO, param);
            return dr;
        }
        /// <summary>
        /// LoadDataDrUsuarioModulo
        ...
        public static OracleDataReader LoadDataDrUsuarioModulo(int codUsuario, int codModulo, OracleTransaction trans)
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(trans, CommandType.StoredProcedure, SPSELECTUSUARIOMODULO, param);
            return dr;
        }
        ...
        public static OracleDataReader LoadDataDrUsuarioModulo(int codUsuario, int codModulo, string codMenu)
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTUSUARIOMODULOMENU, param);
            return dr;
        }
        /// <summary>
        /// LoadDataDrUsuarioModulo
        ...
        public static OracleDataReader LoadDataDrUsuarioModulo(int codUsuario, int codModulo, string codMenu, OracleTransaction trans)
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(trans, CommandType.StoredProcedure, SPSELECTUSUARIOMODULOMENU, param);
            return dr;
        }
        #endregion
        ...
        public static OracleDataReader LoadDataDrModuloMenu(int codModulo, string codMenu)
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTMODULOMENU, param);
            return dr;
        }
        ...
        public static OracleDataReader LoadDataDrModuloMenu(int codModulo, string codMenu, OracleTransaction trans)
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(trans, CommandType.StoredProcedure, SPSELECTMODULOMENU, param);
            return dr;
        }
        #endregion
