...
namespace Classes
{
    public class EventoGrupo2213  // T2213_EVENTO_GRUPO      
    {
        #region Atributos
        ...
        #region Construtores
        public EventoGrupo2213()
            : this(-1)
        { }
        public EventoGrupo2213(int codTituloEv)
        {
        ...
        private const string SPINSERT = "EventoGrupo2213.EventoGrupo2213Inc";
        private const string SPUPDATE = "EventoGrupo2213.EventoGrupo2213Alt";
        private const string SPDELETE = "EventoGrupo2213.EventoGrupo2213Del";
        private const string SPSELECTID = "EventoGrupo2213.EventoGrupo2213SelId";
        private const string SPSELECTPAG = "EventoGrupo2213.EventoGrupo2213SelPag";
        #endregion

        #region Parametros Oracle
        private const string PARMCODIGO = "codTituloEv";
        private const string PARMCURSOR = "curEventoGrupo2213";
        #endregion
        ...
        /// </summary>
        /// <param name="codigo">Código do Registro</param>
        /// <returns>EventoGrupo2213</returns>
        public static EventoGrupo2213 GetDataRow(int codigo)
        {
            OracleDataReader dr = LoadDataDr(codigo);
            EventoGrupo2213 EventoGrupo2213 = new EventoGrupo2213();
            try
            {
                if (dr.Read())
                {
                    EventoGrupo2213.codTituloEv = new TituloEvento(Convert.ToInt32(dr["A022_cd_ev"]));
                    EventoGrupo2213.codCondPagto = new CondicaoPagtoEv(Convert.ToInt32(dr["A2204_cd_cond_pgto"]));
                    EventoGrupo2213.codGrupo2201 = new Grupo2201(Convert.ToInt32(dr["A2201_cd_grupo"]));
                    EventoGrupo2213.codUsuario = new Usuario(Convert.ToInt32(dr["A052_cd_usuario"]));
                    EventoGrupo2213.indFechado = Convert.ToInt32(dr["A2213_id_fechado"]);
                    if (dr["usu_inc_alt"] != DBNull.Value && dr["usu_inc_alt"].ToString() != "")
                        EventoGrupo2213.logUsuario = Convert.ToString(dr["usu_inc_alt"]);
                }
            }
            catch (Exception ex)
            {
                if (!dr.IsClosed)
                    dr.Close();
                EventoGrupo2213 = new EventoGrupo2213();
                throw (ex);
            }
            finally
            {
        ...
        /// <param name="trans">OracleTransaction</param>
        /// <returns>EventoGrupo2213</returns>
        public static EventoGrupo2213 GetDataRow(int codigo, OracleTransaction trans)
        {
