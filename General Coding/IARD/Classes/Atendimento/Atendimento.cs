...
namespace Classes
{
    public class Atendimento // T001_ATEND  
    {
        #region Atributos
        ...
        public static OracleDataReader LoadDataDrHistorico(int codCliente)
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTHISTORICO, param);
            return dr;
        }
        #endregion
        ...
        public static OracleDataReader LoadDataDrAssunto(int numSequencial)
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, "Atendimento.AtendimentoAssuntoSelId", param);
            return dr;
        }
        #endregion
        ...
        public static OracleDataReader LoadDataDrMetricas(int numSequencial)
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, "Atendimento.AtendimentoMetricasSelId", param);
            return dr;
        }
        #endregion
        ...
        public static OracleDataReader LoadDataDrGrafico()
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTGRAFICO, param);
            return dr;
        }
        #endregion
        ...
        public static OracleDataReader LoadDataDrGraficoCliente(int mes, int ano)
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTGRAFICOCLI, param);
            return dr;
        }
        ...
        public static OracleDataReader LoadDataDrRelatorio(string sWhere)
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTRELATORIO, param);
            return dr;
        }
        ...
        public static OracleDataReader LoadDataDrRelProjetos(string sWhereAt, string sWhereEv)
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTRELProjetos, param);
            return dr;
        }
        ...
        public static OracleDataReader LoadDataDrGenerico(string sWhere)
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTGENERICO, param);
            return dr;
        }
