...
namespace Classes
{
    public class DadoAdicionalContato /// T262_DAD_AD_CONT  
    {
        #region Atributos
        ...
        public static OracleDataReader LoadDataDrBuscarLogin(string Login)
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTBuscarLogin, param);
            return dr;
        }
        ...
        public static OracleDataReader LoadDataDrSPBuscarLogin(string Login, OracleTransaction trans)
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(trans, CommandType.StoredProcedure, SPSELECTBuscarLogin, param);
            return dr;
        }
        ...
        public static OracleDataReader LoadDataDrBuscarLoginSenha(string LoginSenha, string Senha)
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTBuscarLoginSenha, param);
            return dr;
        }
        ...
        public static OracleDataReader LoadDataDrSPBuscarLoginSenha(string LoginSenha, string Senha, OracleTransaction trans)
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(trans, CommandType.StoredProcedure, SPSELECTBuscarLoginSenha, param);
            return dr;
        }
        ...
        public static OracleDataReader LoadDataDrBuscarCpf(string Cpf)
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTBuscarCpf, param);
            return dr;
        } 
        ...
        public static OracleDataReader LoadDataDrBuscarCodCliente(string codCli)
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTBuscarCliente, param);
            return dr;
        }
        ...
        /// <returns></returns> 
        public static Paginacao LoadDataBuscaCpfPaginacao(string Where)
        {
            Paginacao paginacao = new Paginacao();
            ...
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTBuscaCPFSelPAG, parms);
        ...
        public static OracleDataReader LoadDataDrBuscarNome(string Nome)
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTBuscarNome, param);
            return dr;
        }
        ...
        public static OracleDataReader LoadDataDrBuscarNome(string Nome, OracleTransaction trans)
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(trans, CommandType.StoredProcedure, SPSELECTBuscarNome, param);
            return dr;
        }
        #endregion
        ...
        /// <param name="Where"></param>
        /// <returns></returns>
        public static Paginacao LoadDataBuscaNomePaginacao(string Where)
        {
            Paginacao paginacao = new Paginacao();
            ...
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTBuscaNomeSelPAG, parms);
        ...
        /// <param name="Where"></param>
        /// <returns></returns>
        public static Paginacao LoadDataBuscaNomePagCredenciado(string Where)
        {
            Paginacao paginacao = new Paginacao();
            ...
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTBuscaNomeSelPAGCREDENCIADO, parms);
