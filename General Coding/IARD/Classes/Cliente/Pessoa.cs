...
namespace Classes
{
    public class Pessoa /// T572_Pessoa
    {
        #region Atributos
        ...
        public static OracleDataReader LoadDataDdlPessoaCombo()
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTPESSOAID, param);
            return dr;
        }
        ...
        public static Paginacao LoadDataPaginacaoCRE(string Where, int PaginaCorrente, int TamanhoPagina, string ExpressaoOrdenacao, int CidadeEvento, string PeriodoIni, string PeriodoFin)
        {
            Paginacao paginacao = new Paginacao();
            ...
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTPAGCRE, parms);
        ...
        public static bool AlteraSenha(string usuario, string senha, string novasenha)
        {
            ...
            DataBase.ExecuteReader(CommandType.StoredProcedure, "Pessoa.PessoaAltSenha", param);
        ...
        public static OracleDataReader LoadDataDdlPessoa()
        {
            ...
            OracleDataReader dr = DataBase.ExecuteReader(CommandType.StoredProcedure, SPSELECTPESSOAGES, param);
            return dr;
        }
