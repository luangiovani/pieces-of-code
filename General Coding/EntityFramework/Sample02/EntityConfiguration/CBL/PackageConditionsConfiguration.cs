...
{
    public class PackageConditionsConfiguration : EntityTypeConfiguration<PackageConditions>
    {
        public PackageConditionsConfiguration()
        {
            HasKey(p => p.packageConditions_id)
                .Property((ac => ac.packageConditions_id)).HasDatabaseGeneratedOption(DatabaseGeneratedOption.Identity);
