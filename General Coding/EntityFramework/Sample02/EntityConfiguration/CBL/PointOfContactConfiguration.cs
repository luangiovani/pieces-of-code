...
{
    public class PointOfContactConfiguration : EntityTypeConfiguration<PointOfContact>
    {
        public PointOfContactConfiguration()
        {
            HasKey(p => p.pointOfContact_id)
                .Property((ac => ac.pointOfContact_id)).HasDatabaseGeneratedOption(DatabaseGeneratedOption.Identity);
