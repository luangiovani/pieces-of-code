...
{
    public class PCBConditionsConfiguration : EntityTypeConfiguration<PCBConditions>
    {
        public PCBConditionsConfiguration()
        {
            HasKey(p => p.pcbCondition_id)
                .Property((ac => ac.pcbCondition_id)).HasDatabaseGeneratedOption(DatabaseGeneratedOption.Identity);
