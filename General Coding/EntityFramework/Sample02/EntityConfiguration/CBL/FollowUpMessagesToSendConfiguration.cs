...
{
    public class FollowUpMessagesToSendConfiguration : EntityTypeConfiguration<FollowUpMessagesToSend>
    {
        public FollowUpMessagesToSendConfiguration()
        {
            ///Primary Key
            ///Propriedade que mapeia a propriedade da entidade que será Chave primária na tabela do banco de dados
            HasKey(f => f.followUpMessagesToSend_id)
                .Property((f => f.followUpMessagesToSend_id)).HasDatabaseGeneratedOption(DatabaseGeneratedOption.Identity);
