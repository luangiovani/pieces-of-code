...
namespace Framework.Database.EntityConfiguration.CBL
{
    ...
    /// <sumary>
    /// Configuracao da Entidade Hear Of Us (Chegou até nós como), para mapeamento na tabela HearOfUs no Banco de Dados
    /// </sumary>
    /// <last_modified_task_url>https://esfera.teamworkpm.net/tasks/7054873</last_modified_task_url>
    /// <last_modified_date>3108/2016</last_modified_date>
    /// <last_modified_programmer>Luan Fernandes</last_modified_programmer>
    /// <last_modified_sumary>Ajustes após remodelagem de dados</last_modified_sumary>
    public class HearOfUsConfiguration : EntityTypeConfiguration<HearOfUs>
    {
        /// <summary>
        /// Constructor
        /// Construtor da classe, mapeando as propriedades com suas peculiaridades
        /// </summary>
        public HearOfUsConfiguration()
        {
            ///Primary Key
            ///Propriedade que mapeia a propriedade da entidade que será Chave primária na tabela do banco de dados
            HasKey(h => h.hearOfUs_id)
                .Property((ac => ac.hearOfUs_id)).HasDatabaseGeneratedOption(DatabaseGeneratedOption.Identity);
