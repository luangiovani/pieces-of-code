...
namespace Framework.Database.EntityConfiguration.CBL
{
    ...
    public class FileAlocationTypeConfiguration : EntityTypeConfiguration<FileAlocationType>
    {
        /// <summary>
        /// Constructor
        /// Construtor da classe, mapeando as propriedades com suas peculiaridades
        /// </summary>
        public FileAlocationTypeConfiguration()
        {
            ///Primary Key
            ///Propriedade que mapeia a propriedade da entidade que será Chave primária na tabela do banco de dados
            HasKey(fa => fa.fileAlocationType_id)
                .Property((ac => ac.fileAlocationType_id)).HasDatabaseGeneratedOption(DatabaseGeneratedOption.Identity);
