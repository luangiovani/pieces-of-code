...
namespace Database.Models.Loja
{
    ...
    /// </atividades>
    /// <summary>
    /// Classe para Mapeamento da Tabela TipoOpcao, indica como esta opção irá se comportar na tela, se será um campo de escolha,
    /// digitação de valores, múltipla escolha...
    /// </summary>
