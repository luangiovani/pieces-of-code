...
namespace Database.Models.Gestao
{
    ...
    /// </atividades>
    /// <summary>
    /// Classe para Mapeamento da tabela SituacaoAvaliacao, nesta tabela serão armazenadas as Situações de Avaliações
    /// Pendente  = Aguardando Avaliador 
    /// Aprovada  = Avaliador Está de Acordo
    /// Reprovada = Avaliador não está de Acordo (Com Justificativa)
    /// </summary>
