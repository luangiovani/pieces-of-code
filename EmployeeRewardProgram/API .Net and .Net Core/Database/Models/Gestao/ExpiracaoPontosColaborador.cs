...
namespace Database.Models.Gestao
{
    ...
    /// </atividades>
    /// <summary>
    /// Classe para Mapeamento da tabela ExpiracaoPontosColaborador, nesta tabela serão armazenadas as 
    /// Expirações de pontos de Colaboradores
    public class ExpiracaoPontosColaborador
    {
        /// <summary>
        ...
        /// <summary>
        /// Identificador da Recomendação que esta expiração pertence
        /// </summary>
        public string recomendacao_id { get; set; }

        /// <summary>
        /// Data que Pontos que expiram
        /// </summary>
