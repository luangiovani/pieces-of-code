namespace Database.Queries.APP
{
    ...
    /// </atividades>
    /// <summary>
    /// Implementação da Interface de Queries para operações de banco de dados da tabela Perfil
    /// </summary>
    public class PerfilQueries : IQueries
    {
        /// <summary>
