namespace Database.Queries.Gestao
{
    ...
    /// </atividades>
    /// <summary>
    /// Implementação da Interface de Queries para operações de banco de dados da tabela MeioDeCompra
    /// </summary>
    public class MeioDeCompraQueries : IQueries
    {
        /// <summary>
        ...
        public string INSERT => @"
            ...
            INSERT INTO [Gestao].[MeioDeCompra]
                (id
                ,nome
                ,ativo
                ,data_hora_criacao
            ...
            SELECT * FROM [Gestao].[MeioDeCompra](NOLOCK) WHERE id = @NID;";

        /// <summary>
        /// Comando de atualização do registro no banco de dados
        /// </summary>
        public string UPDATE => @"
            UPDATE [Gestao].[MeioDeCompra]
               SET [nome] = @nome
                  ,[ativo] = @ativo
        ...
        public string SELECT => @"
            SELECT [id]
                   ...
                   ,[data_hora_alteracao]
                   ,[cs_colaborador_alteracao]
              FROM [Gestao].[MeioDeCompra](NOLOCK)";
