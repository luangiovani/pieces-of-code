namespace Database.Queries.Gestao
{
    ...
    /// </atividades>
    /// <summary>
    /// Implementação da Interface de Queries para operações de banco de dados da tabela SituacaoAvaliacao
    /// </summary>
    public class SituacaoAvaliacaoQueries : IQueries
    {
        /// <summary>
        ...
        public string INSERT => @"
            ...
            INSERT INTO [Gestao].[SituacaoAvaliacao]
                       ([id]
                       ,[nome]
                       ,[descricao]
                       ,[ativo]
            ...
            SELECT * FROM [Gestao].[SituacaoAvaliacao](NOLOCK) WHERE id = @NID;";

        /// <summary>
        /// Comando de atualização do registro no banco de dados
        /// </summary>
        public string UPDATE => @"
            UPDATE [Gestao].[SituacaoAvaliacao]
               SET [nome] = @nome
                   ,[descricao] = @descricao
                   ,[ativo] = @ativo
        ...
        public string SELECT => @"
             SELECT [id]
                    ...
                    ,[data_hora_alteracao]
                    ,[cs_colaborador_alteracao]
               FROM [Gestao].[SituacaoAvaliacao](NOLOCK)";
