namespace Database.Queries.Gestao
{
    ...
    /// </atividades>
    /// <summary>
    /// Implementação da Interface de Queries para operações de banco de dados da tabela Cargo
    /// </summary>
    public class CargoQueries : IQueries
    {
        /// <summary>
        ...
        public string INSERT => @"
                ...
                SELECT * FROM [APP].[Cargo](NOLOCK) WHERE id = @NID;";
        ...
        /// Comando de atualização do registro no banco de dados
        /// </summary>
        public string ELEGIVEL_INELEGIVEL => @"
                UPDATE [Gestao].[Cargo]
                   SET [elegivel] = @elegivel
                      ,[data_hora_alteracao] = GETDATE()
                      ,[cs_colaborador_alteracao] = @cs_colaborador_alteracao
                 WHERE id = @id";
