namespace Database.Queries.Venda
{
    ...
    /// </atividades>
    /// <summary>
    /// Implementação da Interface de Queries para operações de banco de dados da tabela Troca
    /// </summary>
    public class TrocaQueries : IQueries
    {
        /// <summary>
        ...
        public string INSERT => @"
            ...
            INSERT INTO [Venda].[Troca]
                       ([id]
                       ,[compra_id]
                       ,[item_compra_troca_id]
                       ,[item_compra_novo_id]
                       ,[situacao_troca_id]
                       ,[ativo]
                       ,[data_hora_criacao]
                ...
                SELECT * FROM [Venda].[Troca](NOLOCK) WHERE id = @NID;";
        ...
        public string UPDATE => @"
            UPDATE [Venda].[Troca]
               SET [compra_id] = @compra_id
                  ,[item_compra_troca_id] = @item_compra_troca_id
                  ,[item_compra_novo_id] = @item_compra_novo_id
                  ,[situacao_troca_id] = @situacao_troca_id
                  ,[ativo] = @ativo
        ...
        public string SELECT => @"
            SELECT [id]
                  ...
                  ,CONVERT(VARCHAR(255), [item_compra_troca_id]) item_compra_troca_id
                  ,CONVERT(VARCHAR(255), [item_compra_novo_id]) item_compra_novo_id
                  ,CONVERT(VARCHAR(255), [situacao_troca_id]) situacao_troca_id
                  ,[ativo]
                  ,[data_hora_criacao]
                  ,[cs_colaborador_criacao]
                  ,[data_hora_alteracao]
                  ,[cs_colaborador_alteracao]
              FROM [Venda].[Troca](NOLOCK)";
