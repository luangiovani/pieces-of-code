namespace Database.Queries.Venda
{
    ...
    /// </atividades>
    /// <summary>
    /// Implementação da Interface de Queries para operações de banco de dados da tabela SituacaoCompra
    /// </summary>
    public class SituacaoCompraQueries : IQueries
    {
        /// <summary>
        ...
        public string INSERT => @"
            ...
            INSERT INTO [Venda].[SituacaoCompra]
                       ([id]
                       ,[descricao]
                       ,[ativo]
                       ,[data_hora_criacao]
            ...
            SELECT * FROM [Venda].[SituacaoCompra](NOLOCK) WHERE id = @NID;";

        /// <summary>
        /// Comando de atualização do registro no banco de dados
        /// </summary>
        public string UPDATE => @"
            UPDATE [Venda].[SituacaoCompra]
        ...
        public string SELECT => @"
            SELECT [id]
                  ...
                  ,[data_hora_alteracao]
                  ,[cs_colaborador_alteracao]
              FROM [Venda].[SituacaoCompra](NOLOCK)";
