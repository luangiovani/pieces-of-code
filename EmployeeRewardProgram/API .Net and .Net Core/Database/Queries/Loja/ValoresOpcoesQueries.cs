namespace Database.Queries.Loja
{
    ...
    /// </atividades>
    /// <summary>
    /// Implementação da Interface de Queries para operações de banco de dados da tabela ValoresOpcoes
    /// </summary>
    public class ValoresOpcoesQueries : IQueries
    {
        /// <summary>
        ...
        public string INSERT => @"
            ...
            INSERT INTO [Loja].[ValoresOpcoes]
                       ([id]
                       ,[opcao_id]
                       ,[valor]
                       ,[ativo]
            ...
            SELECT * FROM [Loja].[ValoresOpcoes](NOLOCK) WHERE id = @NID;";

        /// <summary>
        /// Comando de atualização do registro no banco de dados
        /// </summary>
        public string UPDATE => @"
            UPDATE [Loja].[ValoresOpcoes]
               SET [opcao_id] = @opcao_id
                  ,[valor] = @valor
                  ,[ativo] = @ativo
        ...
        public string SELECT => @"
            SELECT [id]
                  ...
                  ,[data_hora_alteracao]
                  ,[cs_colaborador_alteracao]
              FROM [Loja].[ValoresOpcoes](NOLOCK)";
