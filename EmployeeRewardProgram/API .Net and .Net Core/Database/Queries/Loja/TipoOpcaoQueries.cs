namespace Database.Queries.Loja
{
    ...
    /// </atividades>
    /// <summary>
    /// Implementação da Interface de Queries para operações de banco de dados da tabela TipoOpcao
    /// </summary>
    public class TipoOpcaoQueries : IQueries
    {
        /// <summary>
        ...
        public string INSERT => @"
            ...
            SELECT * FROM [Loja].[TipoOpcao](NOLOCK) WHERE id = @NID;";

        /// <summary>
        /// Comando de atualização do registro no banco de dados
        /// </summary>
        public string UPDATE => @"
            UPDATE [Loja].[TipoOpcao]
               SET [nome] = @nome
                  ,[descricao] = @descricao
                  ,[ativo] = @ativo
