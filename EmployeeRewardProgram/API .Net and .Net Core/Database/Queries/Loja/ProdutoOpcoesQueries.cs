namespace Database.Queries.Loja
{
    ...
    /// </atividades>
    /// <summary>
    /// Implementação da Interface de Queries para operações de banco de dados da tabela ProdutoOpcoes
    /// </summary>
    public class ProdutoOpcoesQueries : IQueries
    {
        /// <summary>
        ...
        public string INSERT => @"
            ...
            INSERT INTO [Loja].[ProdutoOpcoes]
                       ([id]
                       ,[produto_id]
                       ,[opcao_id]
                       ,[ativo]
            ...
            SELECT * FROM [Loja].[ProdutoOpcoes](NOLOCK) WHERE id = @NID;";

        /// <summary>
        /// Comando de atualização do registro no banco de dados
        /// </summary>
        public string UPDATE => @"
            UPDATE [Loja].[ProdutoOpcoes]
