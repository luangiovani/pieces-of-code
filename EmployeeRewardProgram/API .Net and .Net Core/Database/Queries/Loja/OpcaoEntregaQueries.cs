namespace Database.Queries.Loja
{
    ...
    /// </atividades>
    /// <summary>
    /// Implementação da Interface de Queries para operações de banco de dados da tabela OpcaoEntrega
    /// </summary>
    public class OpcaoEntregaQueries : IQueries
    {
        /// <summary>
        ...
        public string INSERT => @"
            ...
            SELECT * FROM [Loja].[OpcaoEntrega](NOLOCK) WHERE id = @NID;";

        /// <summary>
        /// Comando de atualização do registro no banco de dados
        /// </summary>
        public string UPDATE => @"
            UPDATE [Loja].[OpcaoEntrega]
               SET [label] = @label
