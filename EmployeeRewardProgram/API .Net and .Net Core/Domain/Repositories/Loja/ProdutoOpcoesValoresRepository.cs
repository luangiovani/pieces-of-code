...
namespace Domain.Repositories.Loja
{
    ...
    /// </atividades>
    /// <summary>
    /// Implementação da Interface de Repositório para operações de banco de dados da tabela ProdutoOpcoesValores
    /// </summary>
    public class ProdutoOpcoesValoresRepository : BaseRepository<ProdutoOpcoesValores>
    {
        /// <summary>
        /// Construtor
        /// </summary>
        ...
        public ProdutoOpcoesValoresRepository(IConfiguration configuration, ProdutoOpcoesValoresQueries queries)
