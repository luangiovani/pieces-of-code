...
namespace Domain.Services.Loja
{
    ...
    /// </summary>
    public class ProdutoOpcoesValoresService : BaseService<ProdutoOpcoesValores>
    {
        /// <summary>
        /// Objeto do repositório de manipulação do service
        /// </summary>
        private readonly ProdutoOpcoesValoresRepository _repository;

        /// <summary>
        /// Construtor
        /// </summary>
        /// <param name="repository">Objeto injetado do repositório de banco de dados</param>
        public ProdutoOpcoesValoresService(ProdutoOpcoesValoresRepository repository) : base(repository)
        {
