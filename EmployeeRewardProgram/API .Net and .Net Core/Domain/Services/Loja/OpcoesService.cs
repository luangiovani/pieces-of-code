...
namespace Domain.Services.Loja
{
    ...
    /// </summary>
    public class OpcoesService : BaseService<Opcoes>
    {
        /// <summary>
        /// Objeto do repositório de manipulação do service
        /// </summary>
        private readonly OpcoesRepository _repository;

        /// <summary>
        /// Construtor
        /// </summary>
        /// <param name="repository">Objeto injetado do repositório de banco de dados</param>
        public OpcoesService(OpcoesRepository repository) : base(repository)
        {
