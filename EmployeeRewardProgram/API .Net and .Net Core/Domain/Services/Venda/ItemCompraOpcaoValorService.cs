...
namespace Domain.Services.Venda
{
    ...
    /// </summary>
    public class ItemCompraOpcaoValorService : BaseService<ItemCompraOpcaoValor>
    {
        /// <summary>
        /// Objeto do repositório de manipulação do service
        /// </summary>
        private readonly ItemCompraOpcaoValorRepository _repository;

        /// <summary>
        /// Construtor
        /// </summary>
        /// <param name="repository">Objeto injetado do repositório de banco de dados</param>
        public ItemCompraOpcaoValorService(ItemCompraOpcaoValorRepository repository) : base(repository)
        {
