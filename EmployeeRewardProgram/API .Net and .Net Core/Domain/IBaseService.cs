...
namespace Domain.Services
{
    ...
    /// </atividades>
    /// <summary>
    /// Interface de Services para operações de banco de dados
    /// </summary>
    ...
    public interface IBaseService<Model>
    {
        ...
        /// <returns>id de entidade inserido no banco de dados</returns>
        ...
        /// <summary>
        /// Contrato para método de ativação no banco de dados
        /// </summary>
        /// <param name="id">Id do registro no banco de dados</param>
        /// <param name="cs_colaborador_logado">Id do usuário logado que está realizando a operação</param>
        /// <param name="logOperacaoId">Id do Log de Operação que a transação pertence</param>
