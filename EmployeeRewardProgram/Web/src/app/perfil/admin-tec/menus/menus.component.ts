...
export class MenusComponent implements OnInit {
      ...
      this.service.ObterMenus()
        .subscribe((resp) => {
          if (resp.success) {
            ...
            this.chRef.detectChanges();
            this.dTb.ajusta_toolbar('menu-novo/', this.elementRef, this.router, this.location);
            this.chRef.detectChanges();
  ...
  situacao(id: string = '', nome: string = '', ativo: string = 'true') {
    ...
    Swal.fire({
      ...
      html: 'Deseja ' + (bAtivo ? 'ativar' : 'inativar' ) + ' a opção de menu <b>' + nome + '</b>?',
      type: 'question',
          ...
          .subscribe((recModel) => {
            if (recModel.success) {
              Swal.fire({
                ...
                html: 'Opção de Menu gravado no banco de dados',
                type: 'success',
  ...
  editar(id: string) {
    this.router.navigate(['menu-novo/', id]);
  }
